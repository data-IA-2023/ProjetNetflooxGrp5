...
from sklearn.preprocessing import Binarizer, MinMaxScaler, OneHotEncoder, PolynomialFeatures, RobustScaler
...
df = recup_dataframe("""SELECT "primaryTitle" , "isAdult" , "startYear", "runtimeMinutes", 
             ...
             FROM datanetfloox.predictscore LIMIT 1000000""") 
...
param_grid = [
    ...
    {
        'preprocessor__num__scaler' : [MinMaxScaler(), RobustScaler(),Binarizer(),PolynomialFeatures()],
        'preprocessor__cat__categorical_transformer': [OneHotEncoder(),CountVectorizer()]
    },
...
dump(bestmodel, 'bestparam.joblib')
